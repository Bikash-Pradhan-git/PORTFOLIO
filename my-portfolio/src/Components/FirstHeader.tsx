...
export default function FirstHeadr() {
    ...
    <React.Fragment>
      <div className="First position-relative overflow-hidden p-3 p-md-5 mb-1 text-center">
          ...
          <div className="d-flex flex-column flex-lg-row justify-content-around">
            ...
            <div className="col-12 col-md-8 col-lg-5 p-lg-5 p-md-4 p-3 mx-auto my-4">
              <h1 className="display-4 display-md-5 display-sm-6 fw-normal">
                <Example text={`Hi, I'm `} speed={50} />
                <i className="foo" style={{ color: "rgb(225 79 4)" }}>
                  <Example text={`Abinash.`} speed={50} />
                </i>
              </h1>
              {check ? (
                <p>
        ...
        efforts with this example based on Apple’s marketing pages.`}
              ...
              >
                <a
                  href="https://www.linkedin.com/in/abinashmw?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                ...
                <a
                  href="https://x.com/buboon09?t=FbI5rfeh4CzlkWmWl0lmHA&s=09"
                ...
                <a
                  href="mailto:abinashmedicalresearcher@gmail.com"
                  style={{ textDecoration: "none" }}
                >
                  <li>
                    <EmailIcon
